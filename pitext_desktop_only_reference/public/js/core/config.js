...
export class Config {
  constructor() {
    ...
    this.mermaid = {
      ...
      fontSize: '20px',  /* Increased from 13px for better readability */
      startOnLoad: false,
      securityLevel: 'loose',
      flowchart: {
        htmlLabels: false,
      ...
      sequence: {
        ...
        diagramMarginY: 10,
        actorMargin: 20,
        width: 150,  /* Increased from 100 for better text fit */
        height: 50,  /* Increased from 40 for better text fit */
        boxMargin: 5,
        boxTextMargin: 5,  /* Increased from 3 for better text spacing */
        noteMargin: 5,
        messageMargin: 15,
        mirrorActors: false,
        useMaxWidth: true, // Important: makes diagram responsive
        wrap: true,
        wrapPadding: 10
      },
      themeVariables: {
